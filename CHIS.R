...
# Create exploratory Age histogram
library(ggplot2)
ggplot(adult, aes(x = SRAGE_P)) + geom_histogram()

# Create exploratory BMI value histogram
...
#Create Multiple Histograms (lines 29-43)
...
#Alternative histogram visualizations (lines 45-76)
...
#Creating the histograms with different frequency distributions within each BMI category(lines 79-102)
...
#Create a mosaic plot of the data (lines 105-140)
...
#Add statistics to the mosaic plot (lines 143-166)
...
#Add text to the mosaic plot (lines 169-193)
# Plot so far
p
...
#Wrap all steps into a single function that can be used to examing any two variables of interest
